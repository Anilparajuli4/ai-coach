    ...
    <div>
      ...
      <section className='w-full py-12 md:py-24 lg:py-32 bg-background'>
        <div className='container mx-auto px-4 md:px-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto'>{features.map((feature, index)=>{
            return <Card className='border-2 hover:border-primairy transition-colors duration-300' key={index}>
      ...
      <section className='w-full py-12 md:py-24 lg:py-32 bg-background'>
        <div className='container mx-auto px-4 md:px-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto'>{howItWorks.map((item, index)=>{
            return  <div className='flex flex-col items-center text-center space-y-4' key={index}>
      ...
      <section className='w-full py-12 md:py-24 lg:py-32 bg-muted/50'>
        <div className='container mx-auto px-4 md:px-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>{testimonial.map((testimonial, index)=>{
            return <Card className='bg-background' key={index}>
            <CardContent className='pt-6 '>
             <div className='flex flex-col space-y-4'>
              <div className='flex items-center space-x-4'>
                <div className='relative h-12 w-12 flex-shrink-0'><Image width={40} height={40} src={testimonial.image} alt={testimonial} className='rounded-full object-cover border-2 border-primary/20'/></div>
                <div>
                  <p className='font-semibold'>{testimonial.author}</p>
                  <p className='text-sm text-muted-foreground'>{testimonial.role}</p>
                  <p className='text-sm text-primairy'>{testimonial.company}</p>
                </div>
              </div>
              <blockquote>
      ...
      <section className='w-full py-12 md:py-24 lg:py-32 bg-background'>
        <div className='container mx-auto px-4 md:px-6'>
          ...
          <p className='text-muted-foreground'>Find answers to common question about or platform</p>
          </div>
