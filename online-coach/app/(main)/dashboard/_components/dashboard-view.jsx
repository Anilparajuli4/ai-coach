...
function DashboardView({insights}) {
    ...
    console.log('this is salarydata',salaryData);
    ...
    const nextUpsateDistance = formatDistanceToNow(new Date(insights.nextUpdate), {addSuffix:true})
  ...
  <CardContent>
    ...
    <p className='text-xs text-muted-foreground'>Next update {nextUpsateDistance}</p>
  </CardContent>
